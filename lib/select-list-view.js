// NOTE: This is a copy of select-list-view.js from https://github.com/atom/atom-select-list/pull/27
//       (but with fuzzaldrin replaced by fuzzaldrin-plus). This is to support autocompletion; this
//       file can be replaced with a dependency on atom-select-list when the PR has been merged.
...
module.exports = class SelectListView {
  ...
  update (props = {}) {
    ...
    if (Object.prototype.hasOwnProperty.call(props, 'items')) {
      this.props.items = props.items
      shouldComputeItems = true
    }

    if (Object.prototype.hasOwnProperty.call(props, 'maxResults')) {
      this.props.maxResults = props.maxResults
      shouldComputeItems = true
    }

    if (Object.prototype.hasOwnProperty.call(props, 'filter')) {
      this.props.filter = props.filter
      shouldComputeItems = true
    }

    if (Object.prototype.hasOwnProperty.call(props, 'filterQuery')) {
      this.props.filterQuery = props.filterQuery
      shouldComputeItems = true
    }

    if (Object.prototype.hasOwnProperty.call(props, 'query')) {
      const doDidChangeQuery =
        !Object.prototype.hasOwnProperty.call(props, 'doDidChangeQuery') || props.doDidChangeQuery
      if (!doDidChangeQuery) {
        this.didChangeQueryDisposable.dispose()
      }
    ...
    if (Object.prototype.hasOwnProperty.call(props, 'selectQuery')) {
    ...
    if (Object.prototype.hasOwnProperty.call(props, 'order')) {
      this.props.order = props.order
    }

    if (Object.prototype.hasOwnProperty.call(props, 'emptyMessage')) {
      this.props.emptyMessage = props.emptyMessage
    }

    if (Object.prototype.hasOwnProperty.call(props, 'errorMessage')) {
      this.props.errorMessage = props.errorMessage
    }

    if (Object.prototype.hasOwnProperty.call(props, 'infoMessage')) {
      this.props.infoMessage = props.infoMessage
    }

    if (Object.prototype.hasOwnProperty.call(props, 'loadingMessage')) {
      this.props.loadingMessage = props.loadingMessage
    }

    if (Object.prototype.hasOwnProperty.call(props, 'loadingBadge')) {
      this.props.loadingBadge = props.loadingBadge
    }

    if (Object.prototype.hasOwnProperty.call(props, 'itemsClassList')) {
      this.props.itemsClassList = props.itemsClassList
    }

    if (Object.prototype.hasOwnProperty.call(props, 'initialSelectionIndex')) {
